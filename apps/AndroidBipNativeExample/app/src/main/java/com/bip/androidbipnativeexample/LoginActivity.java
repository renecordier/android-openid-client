...
public class LoginActivity extends AppCompatActivity {
    ...
    private static String scope = "openid email profile appId:di.se";
    private static boolean longLivedToken = false;
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                response = openIdClient.getOpenIdClient().requestAccessToken(openIdClient.getClientId(),
                        scope,
                        mEmail,
                        mPassword,
                        longLivedToken);
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent intent = new Intent(LoginActivity.this, MainLoggedInActivity.class);
